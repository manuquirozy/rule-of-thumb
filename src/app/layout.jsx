            ...
            <div className='hero__featured-card'>
              ...
              <div className='featured-card__content'>
                ...
                <p className='featured-card__more-info'>
                  <a href='http://wikipedia.com' className='underline'>
                    <svg className='featured-card__more-info-icon inline align-top' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 27 18'>
                      <path
          ...
          <aside className='banner banner-top' role='doc-tip' aria-label='Speak Out'>
            ...
            <div className='banner__right'>
              <p className='banner__text'>
                Rule of Thumb is a crowd sourced court of public opinion where anyone and everyone can speak out and speak freely. It’s
                easy: You share your opinion, we analyze and put the data in a public report.
              </p>
            </div>
